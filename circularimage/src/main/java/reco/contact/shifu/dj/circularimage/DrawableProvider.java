...
public class DrawableProvider {
    ...
    public TextDrawable getRound(String text) {
        return TextDrawable.builder().beginConfig().fontSize(toPx(30)).toUpperCase().endConfig().buildRound(text, mGenerator.getColor(text));
    }

    public TextDrawable getRound24(String text) {
        return TextDrawable.builder().beginConfig().fontSize(toPx(30)).toUpperCase().endConfig().buildRound(text, mGenerator.getColor(text));
    }

    public TextDrawable getRoundWithFont(String text, int font) {
        return TextDrawable.builder().beginConfig().fontSize(toPx(font)).toUpperCase().endConfig().buildRound(text, mGenerator.getColor(text));
    }
    ...
    public TextDrawable getRectWithBorder(String text) {
        return TextDrawable.builder().beginConfig().withBorder(toPx(2)).endConfig().buildRect(text, mGenerator.getColor(text));
    }

    public TextDrawable getRoundWithBorder(String text) {
        return TextDrawable.builder().beginConfig().withBorder(toPx(2)).endConfig().buildRound(text, mGenerator.getColor(text));
    }

    public TextDrawable getRoundRectWithBorder(String text) {
        return TextDrawable.builder().beginConfig().withBorder(toPx(2)).endConfig().buildRoundRect(text, mGenerator.getColor(text), toPx(10));
    }

    public TextDrawable getRectWithMultiLetter(String text) {

        return TextDrawable.builder().beginConfig().fontSize(toPx(60)).toUpperCase().endConfig().buildRect(text, mGenerator.getColor(text));
    }

    public TextDrawable getRoundWithCustomFont(String text) {
        return TextDrawable.builder().beginConfig().useFont(Typeface.DEFAULT).fontSize(toPx(15)).textColor(0xfff58559).bold().endConfig()
    ...
    public DrawableProvider(ColorGenerator mGenerator, Context mContext) {
